...
// TODO router.get('/categories/:id', categoryController.category_detail);
// TODO router.get('/categories/:id/create', categoryController.category_create);
...
// TODO router.get('/items/:id/create', itemController.item_create);
